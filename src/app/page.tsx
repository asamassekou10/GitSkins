      ...
      >
        ...
        >
          <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
            ...
            >
              Go beyond widgets. Generate a role-specific README, profile intelligence, and an AI portfolio in minutes.
            </p>
            ...
            >
              {[
                {
                  title: 'Career Mode README',
                  description: 'Tailored narrative, skills, and highlights for your target role.',
                  href: '/readme-generator?careerMode=1&role=fullstack',
                },
                {
                  title: 'Profile Intelligence',
                  description: 'Benchmarks, strengths, and action items generated by Gemini.',
                  href: '/ai',
                },
                {
                  title: 'AI Portfolio',
                  description: 'Auto-generated case studies from your top repositories.',
                ...
                >
                  ...
                  <p style={{ color: '#888', fontSize: '14px', margin: 0 }}>{card.description}</p>
                </a>
              ))}
            </div>
          </div>
