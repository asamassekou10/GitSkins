              ...
              >
                ...
                <div>
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
                    ...
                    <Link href="/github-readme-generator" style={{ fontSize: '14px', color: '#a1a1a1' }}>GitHub README Generator</Link>
                    <Link href="/github-profile-readme-generator" style={{ fontSize: '14px', color: '#a1a1a1' }}>Profile README Generator</Link>
                    <Link href="/github-avatar" style={{ fontSize: '14px', color: '#a1a1a1' }}>GitHub Avatar Generator</Link>
                    <Link href="/github-profile-avatar-generator" style={{ fontSize: '14px', color: '#a1a1a1' }}>Profile Avatar Generator</Link>
